...
<body>
    ...
    <div id="blog-container">
        <div class="blogs">
            ...
            <div class="post">
                <img src="post/<?php echo e($item->image); ?>" alt="Loading..">
                <h3><?php echo e($item->title); ?></h3>
                <p><?php echo e($item->categories); ?></p>
                <i><p>Posted By: <?php echo e($posts->first()->user->name); ?></p></i>
                <p><?php echo e($item->description); ?></p>
                
                <a  href="<?php echo e($item->id); ?>/blog_details">Read More</a>
...
</html><?php /**PATH /var/www/html/Educationwebsite/resources/views/home/blog.blade.php ENDPATH**/ ?>